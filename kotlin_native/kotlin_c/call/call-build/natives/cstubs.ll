...
@"\01knifunptr_call0_callee" = local_unnamed_addr global i8* bitcast (i32 (i32)* @call_callee_wrapper0 to i8*), align 8

; Function Attrs: norecurse nounwind readnone uwtable
define i32 @callee(i32 returned %0) local_unnamed_addr #0 {
  ret i32 %0
}

; Function Attrs: alwaysinline norecurse nounwind readnone uwtable
define i32 @call_callee_wrapper0(i32 returned %0) #1 {
  ret i32 %0
}
