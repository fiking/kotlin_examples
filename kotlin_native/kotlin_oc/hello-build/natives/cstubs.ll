...
define %0* @printArray(%0* %0) local_unnamed_addr #1 {
  ...
  %3 = bitcast %0* %0 to i8*
  %4 = tail call i8* @llvm.objc.retain(i8* %3) #3
...
11:                                               ; preds = %49, %1
  ...
  %16 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %15) #3
  ...
  %22 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %21) #3
  ...
  %28 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %27) #3
  ...
  %34 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %33) #3
  ...
  %40 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %39) #3
  ...
  %46 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %45) #3
  call void (...) @llvm.objc.clang.arc.use(%1* %14, %1* %20, %1* %26, %1* %32, %1* %38) #3
  %47 = bitcast i8* %45 to %0*
  call void @llvm.objc.release(i8* %39) #3, !clang.imprecise_release !10
  call void @llvm.objc.release(i8* %33) #3, !clang.imprecise_release !10
  call void @llvm.objc.release(i8* %27) #3, !clang.imprecise_release !10
  call void @llvm.objc.release(i8* %21) #3, !clang.imprecise_release !10
  call void @llvm.objc.release(i8* %15) #3, !clang.imprecise_release !10
  call void @llvm.objc.release(i8* %3) #3, !clang.imprecise_release !10
  %48 = tail call i8* @llvm.objc.autoreleaseReturnValue(i8* %45) #3
  ret %0* %47
...
49:                                               ; preds = %9, %49
  ...
  %52 = tail call i8* @llvm.objc.retainAutoreleasedReturnValue(i8* %51) #3
  ...
  tail call void @llvm.objc.release(i8* %51) #3, !clang.imprecise_release !10
  %53 = add nuw i64 %50, 1
...
; Function Attrs: nounwind
declare void @llvm.objc.clang.arc.use(...) #3

; Function Attrs: nounwind
declare i8* @llvm.objc.autoreleaseReturnValue(i8*) #3

; Function Attrs: alwaysinline uwtable
define void @hello_sayHello_wrapper0() #5 {
  notail call void (i8*, ...) @NSLog(i8* bitcast (%struct.__NSConstantString_tag* @_unnamed_cfstring_ to i8*)), !clang.arc.no_objc_arc_exceptions !10
  ret void
}

; Function Attrs: alwaysinline uwtable
define %0* @hello_printArray_wrapper1(%0* %0) #5 {
...
attributes #5 = { alwaysinline uwtable "correctly-rounded-divide-sqrt-fp-math"="false" "disable-tail-calls"="false" "frame-pointer"="non-leaf" "less-precise-fpmad"="false" "min-legal-vector-width"="0" "no-infs-fp-math"="false" "no-jump-tables"="false" "no-nans-fp-math"="false" "no-signed-zeros-fp-math"="false" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="apple-a7" "target-features"="+aes,+crypto,+fp-armv8,+neon,+sha2,+zcm,+zcz" "unsafe-fp-math"="false" "use-soft-float"="false" }
